...
const Contact = () => {
  const location = 'University+of+Gujrat';

  // Construct the Google Maps URL with your location
  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto flex">
      <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
        <h2 className="text-gray-900 mb-2 text-lg mb-1 font-medium title-font">Feedback</h2>
